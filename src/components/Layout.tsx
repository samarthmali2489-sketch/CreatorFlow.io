...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen bg-surface text-on-surface selection:bg-primary-container selection:text-on-primary-container relative">
            ...
            {isCreateMenuOpen && (
              <>
                ...
                <div className="absolute top-12 right-0 w-64 bg-white dark:bg-zinc-900/90 backdrop-blur-sm rounded-2xl shadow-lg border border-white/40 p-2 z-50 animate-in slide-in-from-top-2 fade-in duration-200 ring-1 ring-black/5">
                  ...
                  <Link onClick={() => setIsCreateMenuOpen(false)} to="/content-lab/video-to-reels" className="flex items-center gap-3 px-3 py-2.5 hover:bg-zinc-50 dark:bg-zinc-800 rounded-xl transition-colors text-zinc-700 dark:text-zinc-300 hover:text-primary group">
      ...
      {/* Sidebar Navigation */}
      <aside className="fixed left-0 top-0 h-full w-64 border-r border-zinc-200 dark:border-zinc-800/50 bg-white dark:bg-zinc-900/80 backdrop-blur-sm shadow-sm flex-col pt-20 pb-6 px-4 z-40 hidden md:flex">
        <div className="mb-8 px-2">
          <div className="flex items-center gap-3 mb-1">
            <div className="w-8 h-8 bg-primary rounded-lg flex items-center justify-center text-white dark:text-zinc-900 font-bold">
              <span className="material-symbols-outlined text-sm">rocket_launch</span>
            </div>
            <h2 className="text-lg font-bold text-zinc-900 dark:text-white tracking-tight">Pro Studio</h2>
          </div>
          <p className="text-xs text-zinc-500 dark:text-zinc-400 ml-11 uppercase tracking-widest font-bold">Enterprise Plan</p>
        </div>
        
        <nav className="flex-1 space-y-1">
          <Link to="/analytics" className={cn("flex items-center gap-3 px-3 py-2.5 transition-all rounded-xl", location.pathname === '/analytics' ? "text-primary font-bold bg-primary/5 shadow-sm border border-primary/10" : "text-zinc-500 dark:text-zinc-400 hover:bg-zinc-50 dark:bg-zinc-800 hover:text-zinc-900 dark:text-white")}>
          ...
          <div className="py-1">
            <button 
              ...
              className={cn("w-full flex items-center justify-between px-3 py-2.5 transition-all rounded-xl group", location.pathname.includes('/content-lab') ? "text-primary font-bold bg-primary/5 shadow-sm border border-primary/10" : "text-zinc-500 dark:text-zinc-400 hover:bg-zinc-50 dark:bg-zinc-800 hover:text-zinc-900 dark:text-white")}
            >
              <div className="flex items-center gap-3">
            ...
            {isContentLabOpen && (
              <div className="ml-9 mt-2 space-y-1 border-l-2 border-primary/10 pl-3">
                <Link to="/content-lab/video-to-reels" className={cn("flex items-center justify-between px-3 py-2 text-sm transition-all rounded-lg", location.pathname === '/content-lab/video-to-reels' ? "text-primary font-bold bg-primary/5" : "text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:text-white hover:bg-zinc-50 dark:bg-zinc-800")}>
                  <span>Video to Reels</span>
                </Link>
                <Link to="/content-lab/thumbnail-creator" className={cn("block px-3 py-2 text-sm transition-all rounded-lg", location.pathname === '/content-lab/thumbnail-creator' ? "text-primary font-bold bg-primary/5" : "text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:text-white hover:bg-zinc-50 dark:bg-zinc-800")}>Thumbnail Creator</Link>
                <Link to="/content-lab/linkedin-carousels" className={cn("block px-3 py-2 text-sm transition-all rounded-lg", location.pathname === '/content-lab/linkedin-carousels' ? "text-primary font-bold bg-primary/5" : "text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:text-white hover:bg-zinc-50 dark:bg-zinc-800")}>LinkedIn Carousels</Link>
                <Link to="/content-lab/yt-insta-posts" className={cn("block px-3 py-2 text-sm transition-all rounded-lg", location.pathname === '/content-lab/yt-insta-posts' ? "text-primary font-bold bg-primary/5" : "text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:text-white hover:bg-zinc-50 dark:bg-zinc-800")}>YT & Insta Posts</Link>
              </div>
            )}
          </div>
          ...
          <div className="py-1">
            <button 
              ...
              className={cn("w-full flex items-center justify-between px-3 py-2.5 transition-all rounded-xl group", (location.pathname.includes('/saved-') || location.pathname.includes('/content-lab/saved-thumbnails')) ? "text-primary font-bold bg-primary/5 shadow-sm border border-primary/10" : "text-zinc-500 dark:text-zinc-400 hover:bg-zinc-50 dark:bg-zinc-800 hover:text-zinc-900 dark:text-white")}
            >
              <div className="flex items-center gap-3">
            ...
            {isLibraryOpen && (
              <div className="ml-9 mt-2 space-y-1 border-l-2 border-primary/10 pl-3">
                <Link to="/content-lab/saved-thumbnails" className={cn("block px-3 py-2 text-sm transition-all rounded-lg", location.pathname === '/content-lab/saved-thumbnails' ? "text-primary font-bold bg-primary/5" : "text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:text-white hover:bg-zinc-50 dark:bg-zinc-800")}>Saved Thumbnails</Link>
                <Link to="/saved-posts" className={cn("block px-3 py-2 text-sm transition-all rounded-lg", location.pathname === '/saved-posts' ? "text-primary font-bold bg-primary/5" : "text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:text-white hover:bg-zinc-50 dark:bg-zinc-800")}>Saved Posts</Link>
                <Link to="/saved-carousels" className={cn("block px-3 py-2 text-sm transition-all rounded-lg", location.pathname === '/saved-carousels' ? "text-primary font-bold bg-primary/5" : "text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:text-white hover:bg-zinc-50 dark:bg-zinc-800")}>Saved Carousels</Link>
              </div>
            )}
          </div>
          ...
          <div className="py-1">
            <button 
              ...
              className={cn("w-full flex items-center justify-between px-3 py-2.5 transition-all rounded-xl group", location.pathname.includes('/shopify-tools') ? "text-primary font-bold bg-primary/5 shadow-sm border border-primary/10" : "text-zinc-500 dark:text-zinc-400 hover:bg-zinc-50 dark:bg-zinc-800 hover:text-zinc-900 dark:text-white")}
            >
              <div className="flex items-center gap-3">
            ...
            {isShopifyToolsOpen && (
              <div className="ml-9 mt-2 space-y-1 border-l-2 border-primary/10 pl-3">
                <Link to="/shopify-tools/product-photo-studio" className={cn("flex items-center justify-between px-3 py-2 text-sm transition-all rounded-lg", location.pathname === '/shopify-tools/product-photo-studio' ? "text-primary font-bold bg-primary/5" : "text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:text-white hover:bg-zinc-50 dark:bg-zinc-800")}>
                  <span>Product Photo Studio</span>
                  <span className="text-[10px] font-bold bg-zinc-200 text-zinc-600 dark:text-zinc-400 px-1.5 py-0.5 rounded-full">Soon</span>
                </Link>
                <a href="#" className="flex items-center justify-between px-3 py-2 text-sm text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:text-white hover:bg-zinc-50 dark:bg-zinc-800 transition-all rounded-lg">
          ...
          <Link to="/settings" className={cn("flex items-center gap-3 px-3 py-2.5 transition-all rounded-xl", location.pathname === '/settings' ? "text-primary font-bold bg-primary/5 shadow-sm border border-primary/10" : "text-zinc-500 dark:text-zinc-400 hover:bg-zinc-50 dark:bg-zinc-800 hover:text-zinc-900 dark:text-white")}>
            <span className="material-symbols-outlined">settings</span>
            <span>Settings</span>
          </Link>
          <Link to="/integrations" className={cn("flex items-center gap-3 px-3 py-2.5 transition-all rounded-xl", location.pathname === '/integrations' ? "text-primary font-bold bg-primary/5 shadow-sm border border-primary/10" : "text-zinc-500 dark:text-zinc-400 hover:bg-zinc-50 dark:bg-zinc-800 hover:text-zinc-900 dark:text-white")}>
        ...
        <div className="mt-auto space-y-4 pt-6 border-t border-zinc-100 dark:border-zinc-800">
          <div className="bg-primary/5 rounded-xl p-4">
            ...
            <Link to="/upgrade" className={cn("w-full flex items-center justify-center py-2 text-white dark:text-zinc-900 text-xs font-bold rounded-lg transition-colors shadow-sm", subscriptionPlan === 'infinity' ? 'bg-primary hover:bg-primary-dim cursor-default' : 'bg-zinc-900 dark:bg-zinc-100 hover:bg-zinc-800 dark:hover:bg-zinc-700')}>
              {subscriptionPlan === 'infinity' ? 'Your Plan: Infinity' : subscriptionPlan === 'pro' ? 'Upgrade to Infinity' : 'Upgrade Plan'}
            </Link>
          </div>
          <button onClick={signOut} className="w-full flex items-center gap-3 px-3 py-2.5 text-zinc-500 dark:text-zinc-400 hover:text-error transition-colors">
      ...
      {/* Main Content Area */}
      <main className="md:ml-64 pt-24 pb-12 min-h-screen relative z-10 bg-white dark:bg-zinc-900/40">
        <Outlet />
      </main>
    </div>
  );
